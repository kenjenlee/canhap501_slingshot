...
{
    public class haptic_system : MonoBehaviour
    {
        ...
        private void SimulationStep ()
        {
            ...
            lock ( m_ConcurrentDataLock )
            {
                ...
                // This is where I place my code for gravity, set the value of the torque too
                
                m_EndEffectorForce[0] = force.x;
                m_EndEffectorForce[1] = force.y;
        ...
        {
            /*
            Used to update the visual representation of the End effector on the screen based on it's physical position. 
            This is not needed for this simulation.
            */
        ...
        void SetInitialVelocity()
        {
            foreach (GameObject a in celestials)
            {
                ...
                Debug.Log($"{a.name} Velocitie: {a.GetComponent<Rigidbody>().velocity} ");
            }
        }
